...
const u32 gBattleTerrainTilemap_Castle[] = INCBIN_U32("graphics/battle_terrain/castle/tiles.bin.lz");
...
const u32 gBattleTerrainPalette_Castle[] = INCBIN_U32("graphics/battle_terrain/castle/tiles.gbapal.lz");