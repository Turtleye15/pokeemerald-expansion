...
const struct Tileset gTileset_WhitecliffIndoor =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_WhitecliffIndoor,
    .palettes = gTilesetPalettes_WhitecliffIndoor,
    .metatiles = gMetatiles_WhitecliffIndoor,
    .metatileAttributes = gMetatileAttributes_WhitecliffIndoor,
    .callback = NULL,
};

const struct Tileset gTileset_whitecliff_indoor =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_whitecliff_indoor,
    .palettes = gTilesetPalettes_whitecliff_indoor,
    .metatiles = gMetatiles_whitecliff_indoor,
...
const struct Tileset gTileset_calcite_secondary =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_calcite_secondary,
    .palettes = gTilesetPalettes_calcite_secondary,
    .metatiles = gMetatiles_calcite_secondary,
    .metatileAttributes = gMetatileAttributes_calcite_secondary,
    .callback = NULL,
};
